...
document.addEventListener('DOMContentLoaded', function() {
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            handleTabSwitch(this.getAttribute('data-tab'));
        });
    });
    ...
    higherBtn.addEventListener('click', function() { animateCardAction('higher'); });
    lowerBtn.addEventListener('click', function() { animateCardAction('lower'); });
...
function handleTabSwitch(tabName) {
    ...
    switch(tabName) {
        case 'home': break;
        case 'picks': showModal('Picks', 'This would show expert picks and predictions.'); break;
        case 'timeline': showModal('Timeline', 'This would show upcoming games and events.'); break;
        case 'about': showModal('About Us', 'Learn more about our sports gambling platform with AI assistance.'); break;
        case 'contact': showModal('Contact', 'Get in touch with our support team.'); break;
    }
}
